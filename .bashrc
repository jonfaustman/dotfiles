...
alias dup="/System/Library/Frameworks/CoreServices.framework/Versions/A/Frameworks/LaunchServices.framework/Versions/A/Support/lsregister -kill -r -domain local -domain user;killall Finder;echo 'Open With has been rebuilt, Finder will relaunch'"

# Compass
alias watch="compass watch --sourcemap"
alias min="compass compile --output-style compressed --sourcemap --force"
alias compile="compass compile --sourcemap --force"
